...
public class UltimateJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	//On original was Awake unity method, caused troubles because of lifecycle
	...
	//On original was Start unity method, caused troubles because of lifecycle
	...
	public void SetJoystickName(string name)
	{
		joystickName = name;
	}
